...
struct ContentView: View {
    @State private var projects = ["Bookworm", "We Split", "Guess the Flag", "Word Scramble", "Rock Paper Scissor", "Better Rest", "Animations", "Edutainment", "iExpense", "Moonshot", "Habit Tracking", "Cupcake Corner"
    ]
